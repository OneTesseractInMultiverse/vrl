...
7. Run `make check` (consumer types, behavioral coverage, package contents, and isolated tarball consumer). Review the [contract inventory and revision policy](public-contracts.md) for API/data compatibility, preserve older fixtures, and document any migration.
