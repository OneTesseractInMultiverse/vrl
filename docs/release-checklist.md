...
7. Run `make check` (test policy, consumer types, behavioral coverage, selected mutation probes, package contents, and isolated tarball consumer). Review the [contract inventory and revision policy](public-contracts.md) for API/data compatibility, preserve older fixtures, and document any migration.
