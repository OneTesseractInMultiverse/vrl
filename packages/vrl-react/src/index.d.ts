...
export type VrlDiagramDefaults = Pick<VrlDiagramProps, "source" | "options" | "className" | "diagnosticsClassName" | "role">;
...
export interface ReactFactory<E> {
  createElement(type: "div" | "pre", props: Record<string, unknown>, ...children: string[]): E;
}
